    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspControllers", x => new { x.Action, x.Controller });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspRoleControllers", x => new { x.IdentityRoleId, x.Controller, x.Action });
                    table.UniqueConstraint("AK_AspRoleControllers_Action_Controller_IdentityRoleId", x => new { x.Action, x.Controller, x.IdentityRoleId });
                    table.ForeignKey(
                        name: "FK_AspRoleControllers_AspNetRoles_IdentityRoleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProvinceCity = table.Column<string>(nullable: true),
                    PhoneNumber = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserInfors_AspNetUsers_IdentityUserId",
                        column: x => x.IdentityUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserInfors_IdentityUserId",
                table: "UserInfors",
                column: "IdentityUserId");
        }
